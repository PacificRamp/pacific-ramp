export const mockJackUSDABI = [
    ...
    inputs: [
      {
        name: "task",
        type: "tuple",
        internalType: "struct IPacificRampServiceManager.Task",
        components: [
          {
            name: "channelId",
            type: "string",
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        name: "status",
        type: "uint8",
        internalType: "enum IPacificRampServiceManager.OnrampStatus",
      },
      {
        name: "escrowAmount",
        type: "uint256",
    ...
    inputs: [
      {
        name: "params",
        type: "tuple",
        internalType: "struct IPacificRampServiceManager.OfframpRequestParams",
        components: [
          {
            name: "user",
            type: "address",
  ...
  {
    type: "function",
    name: "submitReceiptId",
    inputs: [
      {
        name: "requestOnrampId",
        type: "bytes32",
        internalType: "bytes32",
      },
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: "tuple",
        indexed: false,
        internalType: "struct IPacificRampServiceManager.NewOfframpRequest",
        components: [
          {
            name: "user",
            type: "address",
